...
class ViewTransform {
 public:
  ...
  // Offsets are screen-pixel translations relative to automatic centering.
  // The renderer must first map the center of the rotated image to the
  // viewport center, then apply these offsets.
